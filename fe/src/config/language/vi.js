...
Myshoes.vn hiện đang có chương trình ưu đãi đặc biệt cho các mẫu sneaker mùa thu với mức giảm lên đến 30%. Đến ngay cửa hàng gần nhất hoặc đặt hàng online để sở hữu những đôi sneaker đẹp nhất mùa này!`,
  ...
  Product: {
    ...
    Info: {
      ...
      authentic: "100% Chính hãng, xác thực chống hàng giả",
      freeShipping: "Miễn phí vận chuyển toàn quốc cho đơn hàng trên 500k",
      returnPolicy: "Chính sách đổi trả 7 ngày nếu có lỗi sản xuất",
      warranty: "Bảo hành chính hãng 6 tháng",
    },
    Gallery: {
    ...
    Tabs: {
      ...
      reviewsTitle: "Đánh giá khách hàng",
      brand: "Thương hiệu",
      type: "Loại",
      color: "Màu sắc",
      size: "Size",
      descriptionText: "là một trong những dòng giày thể thao cao cấp từ",
      descriptionText2: "mang đến sự kết hợp hoàn hảo giữa phong cách thời trang và hiệu suất thể thao.",
      descriptionText3: "Với thiết kế độc đáo và chất liệu cao cấp, sản phẩm này không chỉ đảm bảo sự thoải mái tối đa khi mang mà còn tạo nên phong cách cá nhân riêng biệt cho người dùng.",
    },
    Reviews: {
      ...
      noReviewsForRating: "Không có",
      rating: "sao đánh giá",
      noReviewsYet: "Chưa có đánh giá cho sản phẩm này",
