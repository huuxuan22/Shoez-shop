      ...
      <nav class="container mx-auto px-4 py-4">
          ...
          <div class="flex items-center space-x-4">
            ...
            >
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 6M7 13l-1.5 6m0 0h9m-9 0h9m0 0l1.5-6M7 13h10" />
              </svg>
              <!-- Cart Badge (optional) -->
        ...
        <div v-if="showMobileMenu" class="md:hidden mt-4 border-t pt-4">
          <div class="flex flex-col space-y-2">
            <router-link to="/" class="text-gray-700 hover:text-blue-600 py-2">Trang chủ</router-link>
            <router-link to="/products" class="text-gray-700 hover:text-blue-600 py-2">Sản phẩm</router-link>
            <router-link to="/about" class="text-gray-700 hover:text-blue-600 py-2">Về chúng tôi</router-link>
            <router-link to="/contact" class="text-gray-700 hover:text-blue-600 py-2">Liên hệ</router-link>
            
            <div v-if="!isAuthenticated" class="border-t pt-2 mt-2">
              <router-link to="/login" class="block text-gray-700 hover:text-blue-600 py-2">Đăng nhập</router-link>
              <router-link to="/register" class="block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 mt-2">Đăng ký</router-link>
            </div>
          </div>
        </div>
      </nav>
